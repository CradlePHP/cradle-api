...
/**
 * $ cradle package install cradlephp/cradle-api
 * $ cradle package install cradlephp/cradle-api 1.0.0
 * $ cradle cradlephp/cradle-api install
 * $ cradle cradlephp/cradle-api install 1.0.0
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-install', function ($request, $response) {
    //custom name of this package
    $name = 'cradlephp/cradle-api';
    ...
    // install package
    $version = $this->package('cradlephp/cradle-api')->install('0.0.0');
...
/**
 * $ cradle package update cradlephp/cradle-api
 * $ cradle package update cradlephp/cradle-api 1.0.0
 * $ cradle cradlephp/cradle-api update
 * $ cradle cradlephp/cradle-api update 1.0.0
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-update', function ($request, $response) {
    //custom name of this package
    $name = 'cradlephp/cradle-api';
    ...
    if (version_compare($version, $current, '<')) {
        ...
        $response->setResults('logs', 'cradlephp/cradle-api', $version, [
            [
                'type' => 'error',
                'message' => $message
            ]
    ...
    // update package
    $version = $this->package('cradlephp/cradle-api')->install($current);
...
/**
 * $ cradle package remove cradlephp/cradle-api
 * $ cradle cradlephp/cradle-api remove
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-remove', function ($request, $response) {
    //custom name of this package
    $name = 'cradlephp/cradle-api';
...
/**
 * $ cradle elastic flush cradlephp/cradle-api
 * $ cradle cradlephp/cradle-api elastic-flush
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-elastic-flush', function ($request, $response) {
    $processed = $errors = [];
    //scan through each file
    foreach (scandir(__DIR__ . '/schema') as $file) {
        //if it's not a php file
...
/**
 * $ cradle elastic map cradlephp/cradle-api
 * $ cradle cradlephp/cradle-api elastic-map
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-elastic-map', function ($request, $response) {
    $processed = $errors = [];
    //scan through each file
    foreach (scandir(__DIR__ . '/schema') as $file) {
        //if it's not a php file
...
/**
 * $ cradle elastic populate cradlephp/cradle-api
 * $ cradle cradlephp/cradle-api elastic-populate
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-elastic-populate', function ($request, $response) {
    $processed = $errors = [];
    //scan through each file
    foreach (scandir(__DIR__ . '/schema') as $file) {
        //if it's not a php file
...
/**
 * $ cradle redis flush cradlephp/cradle-api
 * $ cradle cradlephp/cradle-api redis-flush
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-redis-flush', function ($request, $response) {
    // initialize schema
...
/**
 * $ cradle redis populate cradlephp/cradle-api
 * $ cradle cradlephp/cradle-api redis-populate
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-redis-populate', function ($request, $response) {
    // initialize schema
    $schema = Schema::i('profile');
    // get sql service
...
/**
 * $ cradle sql build cradlephp/cradle-api
 * $ cradle cradlephp/cradle-api sql-build
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-sql-build', function ($request, $response) {
...
/**
 * $ cradle sql flush cradlephp/cradle-api
 * $ cradle cradlephp/cradle-api sql-flush
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-sql-flush', function ($request, $response) {
    //load up the database
    $pdo = $this->package('global')->service('sql-main');
    $database = SqlFactory::load($pdo);
...
/**
 * $ cradle sql populate cradlephp/cradle-api
 * $ cradle cradlephp/cradle-api sql-populate
 *
 * @param Request $request
 * @param Response $response
 */
$this->on('cradlephp-cradle-api-sql-populate', function ($request, $response) {
    //scan through each file
    foreach (scandir(__DIR__ . '/schema') as $file) {
        //if it's not a php file
        if(substr($file, -4) !== '.php') {
